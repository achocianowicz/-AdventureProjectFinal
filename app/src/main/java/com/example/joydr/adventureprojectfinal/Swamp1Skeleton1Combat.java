...
public class Swamp1Skeleton1Combat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_swamp1_skeleton1_combat);

        f1B1enemyName = findViewById(R.id.s1S1enemyName);
        f1B1enemyLevel = findViewById(R.id.s1S1enemyLevel);
        f1B1enemyHP = findViewById(R.id.s1S1enemyHP);
        f1B1enemyMP = findViewById(R.id.s1S1enemyMP);


        f1B1charName = findViewById(R.id.s1S1charName);
        f1B1charLevel = findViewById(R.id.s1S1charLevel);
        f1B1charHP = findViewById(R.id.s1S1charHP);
        f1B1charMP = findViewById(R.id.s1S1charMP);


        f1B1enemyImage = findViewById(R.id.s1S1enemyImage);
        f1B1charImage = findViewById(R.id.s1S1charImage);

        f1B1hpButton = findViewById(R.id.s1S1hpButton);
        f1B1mpButton = findViewById(R.id.s1S1mpButton);

        f1B1charAttack1 = findViewById(R.id.s1S1charAttack1);
        f1B1charAttack2 = findViewById(R.id.s1S1charAttack2);
        f1B1charSpell1 = findViewById(R.id.s1S1charSpell1);


        f1B1toGoToReward = findViewById(R.id.s1S1toGoToReward);
        f1B1toGoToFailQuest = findViewById(R.id.s1S1toGoToFailQuest);
