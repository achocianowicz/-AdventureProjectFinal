...
public class Mountian1Goat1Combat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mountian1_goat1_combat);

        f1B1enemyName = findViewById(R.id.m1G1enemyName);
        f1B1enemyLevel = findViewById(R.id.m1G1enemyLevel);
        f1B1enemyHP = findViewById(R.id.m1G1enemyHP);
        f1B1enemyMP = findViewById(R.id.m1G1enemyMP);


        f1B1charName = findViewById(R.id.m1G1charName);
        f1B1charLevel = findViewById(R.id.m1G1charLevel);
        f1B1charHP = findViewById(R.id.m1G1charHP);
        f1B1charMP = findViewById(R.id.m1G1charMP);


        f1B1enemyImage = findViewById(R.id.m1G1enemyImage);
        f1B1charImage = findViewById(R.id.m1G1charImage);

        f1B1hpButton = findViewById(R.id.m1G1hpButton);
        f1B1mpButton = findViewById(R.id.m1G1mpButton);

        f1B1charAttack1 = findViewById(R.id.m1G1charAttack1);
        f1B1charAttack2 = findViewById(R.id.m1G1charAttack2);
        f1B1charSpell1 = findViewById(R.id.m1G1charSpell1);


        f1B1toGoToReward = findViewById(R.id.m1G1toGoToReward);
        f1B1toGoToFailQuest = findViewById(R.id.m1G1toGoToFailQuest);

        b1F1battleText = findViewById(R.id.m1G1battleText);
// Enemy
        f1B1enemyName.setText("Goat");
...
// char
    ...
    public void CheckCharHealth(Double cHP){
        if(cHP > 0){
            ...
            Singleton.getInstance().setQuestTitle("Mountian 1 Goat 1 Combat");
    ...
    public void Combat(Attack charAttack) {
        Attack bear1Attack1 = new Attack("Kick", 20, 40);
        Attack bear2Attack2 = new Attack ("HeadButt", 40, 60 );
