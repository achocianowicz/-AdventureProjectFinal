...
public class Coast1Crab1Combat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coast1_crab1_combat);

        f1B1enemyName = findViewById(R.id.c1C1enemyName);
        f1B1enemyLevel = findViewById(R.id.c1C1enemyLevel);
        f1B1enemyHP = findViewById(R.id.c1C1enemyHP);
        f1B1enemyMP = findViewById(R.id.c1C1enemyMP);


        f1B1charName = findViewById(R.id.c1C1charName);
        f1B1charLevel = findViewById(R.id.c1C1charLevel);
        f1B1charHP = findViewById(R.id.c1C1charHP);
        f1B1charMP = findViewById(R.id.c1C1charMP);


        f1B1enemyImage = findViewById(R.id.c1C1enemyImage);
        f1B1charImage = findViewById(R.id.c1C1charImage);

        f1B1hpButton = findViewById(R.id.c1C1hpButton);
        f1B1mpButton = findViewById(R.id.c1C1mpButton);

        f1B1charAttack1 = findViewById(R.id.c1C1charAttack1);
        f1B1charAttack2 = findViewById(R.id.c1C1charAttack2);
        f1B1charSpell1 = findViewById(R.id.c1C1charSpell1);


        f1B1toGoToReward = findViewById(R.id.c1C1toGoToReward);
        f1B1toGoToFailQuest = findViewById(R.id.c1C1toGoToFailQuest);

        b1F1battleText = findViewById(R.id.c1C1battleText);
// Enemy
        f1B1enemyName.setText("crab");
...
// char
        ...
        f1B1toGoToReward.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Singleton.getInstance().setCoastQuest1Done(true);
    ...
    public void CheckCharHealth(Double cHP){
        if(cHP > 0){
            ...
            Singleton.getInstance().setQuestTitle("Coast 1 Crab 1 Combat");
    ...
    public void Combat(Attack charAttack) {
        Attack bear1Attack1 = new Attack("Pinch", 20, 10);
        Attack bear2Attack2 = new Attack("Bubble", 30, 50);
