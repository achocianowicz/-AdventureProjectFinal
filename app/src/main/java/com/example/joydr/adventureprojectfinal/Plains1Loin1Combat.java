...
// char
    ...
    public void CheckCharHealth(Double cHP){
        if(cHP > 0){
            ...
            Singleton.getInstance().setQuestTitle("Plains 1 Lion 1 Combat");
    ...
    public void Combat(Attack charAttack) {
        Attack bear1Attack1 = new Attack("Claw", 30, 70);
        Attack bear2Attack2 = new Attack("Bite", 40, 50);
